  ...
  return (
    <div className='main-layout vertical-center-div'>
      <div className='skinny-skinny-container'>
        ...
        <Typography.Text>Skidoodle is a multi-player doodling game similar to pictionary. Players take turns sketching words, then trying
          ...
          high score board.</Typography.Text>
        ...
        <Typography.Text>Github Repo: </Typography.Text><a href='https://github.com/annateng/Skidoodle'>https://github.com/annateng/skidoodle</a>
      </div>
    </div>
  )
}
