  ...
  return (
    <div className='main-layout vertical-center-div'>
      ...
      <div className='skinny-skinny-container'>
        <Typography.Title><SettingTwoTone />&nbsp;&nbsp;Settings for <Link to={`/profile/${user.user.id}`}>{user.user.username}</Link></Typography.Title>
        <Form onFinish={handleUpdateSettings} onFinishFailed={() => console.error('Required form fields missing.')}
          ...
          <Form.Item label='How frequently would you like to receive e-mail game alerts?' name='alertFreq'>
            <Radio.Group>
              <Radio value='ALL'>As they come</Radio><br/>
