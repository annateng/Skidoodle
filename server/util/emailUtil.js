                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="content-block">
                      <span class="apple-link">skidoodle</span>
                    </td>
                  </tr>
                </table>
              </div>
...
const sendUpdate = async (emailAddr, text, name, buttonText, path) => {
  ...
  <html>
    ...
    <body class="">
      <span class="preheader">Skidoodle notification from ${name}</span>
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
        <tr>
          <td>&nbsp;</td>
          <td class="container">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>
                              ...
                              <tr>
                                <td align="left">
                                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                      <tr>
                                        <td> <a href="${common.BASE_URL}${path}" target="_blank">${buttonText}</a> </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
                          ...
                          <p><a href="${common.BASE_URL}/settings" target="_blank">Change e-mail alert settings</a></p>
                        </td>
                      </tr>
                    </table>
                  </td>
