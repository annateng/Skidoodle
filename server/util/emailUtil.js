...
const sendInvite = async (emailAddr, name)  => {
  const emailHtml = `
  <!doctype html>
  <html>
    <head>
                ...
                <tr>
                  <td class="wrapper">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td>
                          <p>${name} has invited you to play skidoodle! Follow the link below to get started.</p>
                              ...
                              <tr>
                                <td align="left">
                                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tbody>
                                      <tr>
                                        <td> <a href="http://htmlemail.io" target="_blank">Let's play</a> </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
